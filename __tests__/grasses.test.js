...
describe('Grass Routes', () => {
    ...
    describe('GET /grasses/:id', () => {
        it('should return on grass', async () => {
            ...
            expect(response.status).toBe(200);
            expect(response.body).toBeDefined();
            expect(respose.body.data.grass._id).toBe('649117b69b4e0bbe9c801f60');
        });
    });
    ...
    describe('POST /grasses to add new grasses', () => {
        it.skip('should create new grass', async () => {
            const response = await request(app).post('/grasses')
            .send ({
                name: 'A new grass',
                heatTolerant: 'true',
                coldTolerant: 'true',
    ...
    describe('PUT /grasses/:id to update grass', () => {
        it.skip('should update a grass', async () => {
            const response = await request(app).put('/grasses/649117b69b4e0bbe9c801f60')
            .send({
    ...
    describe('DELETE /grasses/:id', () => {
        it.skip('should delete one grass', async () => {
            const response = await request(app).delete('/grasses/649117b69b4e0bbe9c801f65');
